...
class DremioSQLQueries:
    ...
    # Global variant: fetches all CE datasets in a single query without per-container filtering.
    ...
    # Global variant: fetches all datasets in a single query without per-container filtering.
    # Replaces the N per-container queries (each ~10s planning overhead) with one query.
    ...
    # Global variant: fetches all Cloud datasets in a single query without per-container filtering.
